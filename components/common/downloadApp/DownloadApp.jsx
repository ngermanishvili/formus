...
export default function DownloadApp() {
  ...
  return (
    <div className="flex justify-center items-center my-[30px] sm:my-[40px] lg:my-[100px] px-4 sm:px-6 lg:px-8">
      <section className="min-h-[200px] sm:min-h-[220px] lg:min-h-[250px] w-full  max-w-[1300px] rounded-2xl min-[2000px]:w-[1300px] min-[2000px]:mr-52 bg-[#abc188] relative overflow-hidden">
